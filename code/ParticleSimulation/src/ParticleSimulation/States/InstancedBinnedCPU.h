...
namespace ParticleSimulation {
	...
	class InstancedBinnedCPU : public Novaura::State
	{
	public:
		InstancedBinnedCPU();		
		InstancedBinnedCPU(std::shared_ptr<Novaura::Window> window, std::shared_ptr<Novaura::CameraController> cameraController, std::shared_ptr<Novaura::StateMachine> stateMachine);
		~InstancedBinnedCPU();
