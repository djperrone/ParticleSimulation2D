...
namespace ParticleSimulation {
	...
	class InstancedBinnedGPU : public Novaura::State
	{
	public:
		InstancedBinnedGPU();		
		InstancedBinnedGPU(std::shared_ptr<Novaura::Window> window, std::shared_ptr<Novaura::CameraController> cameraController, std::shared_ptr<Novaura::StateMachine> stateMachine);
