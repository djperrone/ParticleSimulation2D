...
namespace ParticleSimulation {
	...
	class BinnedGPU2 : public Novaura::State
	{
	public:
		BinnedGPU2();		
		BinnedGPU2(std::shared_ptr<Novaura::Window> window, std::shared_ptr<Novaura::CameraController> cameraController, std::shared_ptr<Novaura::StateMachine> stateMachine);
