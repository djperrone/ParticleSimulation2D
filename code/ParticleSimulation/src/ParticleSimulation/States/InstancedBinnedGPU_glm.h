...
namespace ParticleSimulation {
	...
	class InstancedBinnedGPU_glm : public Novaura::State
	{
	public:
		InstancedBinnedGPU_glm();		
		InstancedBinnedGPU_glm(std::shared_ptr<Novaura::Window> window, std::shared_ptr<Novaura::CameraController> cameraController, std::shared_ptr<Novaura::StateMachine> stateMachine);
