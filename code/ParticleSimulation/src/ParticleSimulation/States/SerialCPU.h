...
namespace ParticleSimulation {
	...
	class SerialCPU : public Novaura::State
	{
	public:
		SerialCPU();		
		SerialCPU(std::shared_ptr<Novaura::Window> window, std::shared_ptr<Novaura::CameraController> cameraController, std::shared_ptr<Novaura::StateMachine> stateMachine);
