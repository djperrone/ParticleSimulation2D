...
namespace Physics {
    ...
    __device__ void apply_force_gpu(common::particle_t& particle, common::particle_t& neighbor)
    {
        ...
        //if (r2 > common::ParticleData::cutoff * common::ParticleData::cutoff)
        //    return;
        ////r2 = fmax( r2, min_r*min_r );
        //r2 = (r2 > common::ParticleData::min_r * common::ParticleData::min_r) ? r2 : common::ParticleData::min_r * common::ParticleData::min_r;
        //double r = sqrt(r2);

        ////
        ////  very simple short-range repulsive force
        ////
        //double coef = (1 - common::ParticleData::cutoff / r) / r2 / common::ParticleData::mass;
        //particle.ax += coef * dx;
        //particle.ay += coef * dy;
    }
    ...
    __global__ void move_gpu(Block* grid, int blocks_per_side, double size)
    {
        ...
        //    p->vx += p->ax * common::ParticleData::dt;
        //    p->vy += p->ay * common::ParticleData::dt;
        //    p->x += p->vx * common::ParticleData::dt;
        //    p->y += p->vy * common::ParticleData::dt;
